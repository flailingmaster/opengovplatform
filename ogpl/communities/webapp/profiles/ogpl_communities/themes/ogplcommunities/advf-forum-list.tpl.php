...
<div class="link-wrapper"><a class="join-link" href="/communities/og/subscribe/<?php print arg(1);?>?destination=node/<?php print arg(1);?>/forums">Join This Community</a></div>
<?php endif; ?>
<table id="forum-<?php print $forum_id; ?>" class="forum-table">
   <caption><?php print $forum_description;?></caption>
  <thead class="forum-header">
    <tr>
      ...
      <?php if(user_access('subscribe to taxonomy terms')){ ?>
      <th class="forum-subscription"><?php print t('Subscriptions'); ?></th>
      <?php } ?>
    </tr>
  </thead>
          ...
          <tr id="forum-list-<?php print $child_id; ?>" class="<?php print $forum->zebra; ?> <?php print $forum->row_classes;?> in-container-<?php print $forum->container_id;?>">
            ...
            <td>
              <?php print str_repeat('<div class="indent">', $forum->depth - $container_adjustment); ?>
                <div class="forum-details">
                  <div class="name"><a href="<?php /*print $forum->link;*/ print "/communities/node/".arg(1)."/forums/".$child_id; ?>"><?php print $forum->name; ?></a></div>
                  <?php if ($forum->description): ?>
                    <div class="description"><?php print $forum->description; ?></div>
                  <?php endif; ?>
                </div>
            ...
            <td class="topics">
              <div class="num num-topics"><?php print $forum->num_topics ?>
                <?php if ($forum->new_topics): ?>
                  <div class="num num-new-topics red"><a href="<?php print $forum->new_url; ?>"><?php print $forum->new_text; ?></a></div>
                <?php endif; ?>
              </div>
            </td>
