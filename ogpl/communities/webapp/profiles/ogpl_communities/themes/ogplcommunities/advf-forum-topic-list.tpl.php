...
<?php print $pager;?>
<?php global $user;  
if ($user->uid && !og_is_group_member(arg(1))):?>
	<em><?php print "You must join this community to post forum topics.";?></em>
 	<div class="link-wrapper"><a class="join-link" href="/communities/og/subscribe/<?php print arg(1);?>?destination=node/<?php print arg(1);?>">Join This Community</a></div>
<?php endif; ?>
...
<table id="forum-topic-<?php print $topic_id; ?>" class="forum-topics">
  ...
  <?php foreach ($topics as $topic): ?>
    ...
    <tr class="<?php print $topic->zebra;?> <?php print $topic->sticky_class;?>">
      ...
      <td class="title">
      <?php print l(strip_tags($topic->title),"node/".arg(1)."/forums/topic/".$topic->nid). $topic_new; ?>
