...
<body class="<?php print $body_classes; ?> show-grid">
	...
	<div class="container-12 logo-container">
		<div class="grid-5 alpha logo-left">
			<span id="logo"><a href="<?php print base_path(); ?>"><img src="<?php print '/'.path_to_theme().'/images/logo.png' ?>" title="Go to OGPL Communities Home" alt="OGPL Communities" /></a></span>
		</div><!--logo, grid-6-->
		...
		<div class="header header-main grid-12">
			<div class="grid-12 alpha omega">
					<div class="community-nav community-nav-page clear-block">
						<ul class="clear-block grid-12"></ul>

                        <!-- Search block code was originally here -->
  ...
  <div id="footer-container" class="container-12 clear-block">
	...
	</div></div> <!--main-container container-12-->
