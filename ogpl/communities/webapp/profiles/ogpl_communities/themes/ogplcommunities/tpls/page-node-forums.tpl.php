...
<body class="<?php print $body_classes; ?> show-grid">
		...
		<div class="title-container grid-12 display-inline">
			...
			<div class="grid-12 alpha omega">
				<?php if (in_array('og', module_list())) : ?>
					<div class="community-nav clear-block">
						<ul class="clear-block"><?php print ctools_menu_local_tasks() ?></ul>
					</div>
				<?php else: ?>
					<?print ($tabs)?>
				<?php endif;?>
	...
	<div id= "main-container" class="container-12 clear-block">
		...
		<?php print $messages; ?>
		<?php print $help; ?>
		 <div id= "feed-container" class="container-12 clear-block">
			<div id ='feed-block' class="grid-1 push-11  omega" ><?php print $feed_icons; ?></div>
		</div>
        <?php print $content; ?>
      	</div>
    </div>
