...
$(document).ready(function(){
  ...
  $(".view-id-og_datagov_data_tools th.views-field-field-api-link-url:not(.active)").children("a[title^='sort']").attr('href', function() {
...
;
dw_fontSizerDX.set(14, 12, 20, ['#main-container'] );
dw_fontSizerDX.set(14, 12, 20, ['.showcase'] );
