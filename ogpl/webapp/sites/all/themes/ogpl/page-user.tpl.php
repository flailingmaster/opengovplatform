...
<head>
  ...
  @import "<?php echo $base_url.'/'.drupal_get_path('theme', 'fusion_core');?>/css/style.css?i";
  @import "<?php echo $base_url.'/'.drupal_get_path('theme', 'fusion_core');?>/css/typography.css?i";
  @import "<?php echo $base_url.'/'.drupal_get_path('theme', 'fusion_core');?>/css/superfish.css?i";
  @import "<?php echo $base_url.'/'.drupal_get_path('theme', 'fusion_core');?>/css/superfish-navbar.css?i";
  @import "<?php echo $base_url.'/'.drupal_get_path('theme', 'fusion_core');?>/css/superfish-vertical.css?i";
  ...
  <?php //print $styles; ?>
  <link type="text/css" rel="stylesheet" media="all" href="<?php echo $base_url.'/'.drupal_get_path('theme', 'fusion_core');?>/css/grid16-fluid.css?i"/>
  <!--[if IE 8]>
  <link type="text/css" rel="stylesheet" media="all" href="<?php echo $base_url.'/'.drupal_get_path('theme', 'fusion_core');?>/css/ie8-fixes.css?i" />
  <![endif]-->
  <!--[if IE 7]>
  <link type="text/css" rel="stylesheet" media="all" href="<?php echo $base_url.'/'.drupal_get_path('theme', 'fusion_core');?>/css/ie7-fixes.css?i" />
  <![endif]-->
  <!--[if lte IE 6]>
