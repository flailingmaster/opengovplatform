    ...
    <tr>
      <?php foreach ($header as $field => $label): ?>
        <?php 
		  if($field=='title')
		  {
		   print '<th class="views-field views-field-<?php print $fields[$field]; ?> ds-list-head-new-first" >';
		   print $label; 
		   }
		   ...
		   if($field==='field_ds_agency_short_name_value') 
		  {  print '<th class="views-field views-field-<?php print $fields[$field]; ?> ds-list-head-new" style="text-align:center;">';
		    print $label; }
		    if($field==='phpcode')
		  {  print '<th class="views-field views-field-<?php print $fields[$field]; ?> ds-list-head-new-last" >';
		    print $label; }
    ...
    <?php foreach ($rows as $count => $row): ?>
      <tr class="<?php print implode(' ', $row_classes[$count]); ?>">
        <?php foreach ($row as $field => $content): ?>
		  ...
		  <?php if($field=='field_ds_agency_short_name_value')
				 {
